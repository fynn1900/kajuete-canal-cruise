...
const translations = {
  de: {
    ...
    card2Sub: 'Natürlich haben wir mehr 1621 & Drinks an Bord. Grachtenmusik und Geschichten über das Grachtenstädtchen im Abendlicht auf dem Wasser genießen.',
    card3Title: 'Preise',
    card3Adult: 'pro Person',
    card3Kid: 'Kids von 2–7 Jahren',
    card3Note: 'Bezahlung in der Kajüte · Keine Vorauszahlung',
    card3Exclusive: 'Exklusive Fahrt nur für eure Gruppe / Familie · +6 € pro Person',
    ...
    beforeTripDesc: 'Kommt doch um 18 Uhr zum Flammkuchen in die Kajüte oder den Grachtengarten und steigt danach direkt aufs Boot. Wenn ihr das so plant, könnt ihr hier einen Tisch reservieren.',
    ...
    // Exclusive
    exclusiveLabel: 'Exklusive Fahrt — nur für eure Gruppe',
    exclusiveDesc: '+6 € pro Person · Das Boot gehört euch alleine',
    // Safety & Liability
  ...
  en: {
    ...
    card2Sub: 'Of course we have more 1621 & drinks on board. Canal music and stories about the little Dutch town — enjoyed in the evening light on the water.',
    card3Title: 'Prices',
    card3Adult: 'per person',
    card3Kid: 'Kids aged 2–7',
    card3Note: 'Payment at the Kajüte · No prepayment',
    card3Exclusive: 'Exclusive trip just for your group / family · +€6 per person',
    ...
    exclusiveLabel: 'Exclusive trip — just for your group',
    exclusiveDesc: '+€6 per person · The boat is all yours',
