...
const translations = {
  de: {
    ...
    offSeasonMsg: 'In den Wintermonaten macht Fynn Pause — ab 15. Juni geht\'s wieder los.',
    seasonNote: 'Saison 2026',
    seasonEndTitle: 'Saison 2026 beendet',
    seasonEndText: 'Die Saison ist vorbei — wir sehen uns 2027! Bis dahin freuen wir uns auf euch in der Kajüte 1876.',
  ...
  en: {
    ...
    offSeasonMsg: 'Fynn takes a winter break — bookings open again from June 15.',
    seasonNote: 'Season 2026',
    seasonEndTitle: 'Season 2026 ended',
    seasonEndText: 'The season is over — see you in 2027! Until then, we look forward to welcoming you at Kajüte 1876.',
    loading: 'Loading…',
    spotsLeft: 'available',
    of: 'of',
    noTrip: 'No Trip',
  ...
  da: {
    ...
    offSeasonMsg: 'Fynn holder vinterpause — tilmelding mulig igen fra 15. juni.',
    seasonNote: 'Sæson 2026',
    seasonEndTitle: 'Sæson 2026 afsluttet',
    seasonEndText: 'Sæsonen er slut — vi ses i 2027! Indtil da ser vi frem til at byde jer velkommen i Kajüte 1876.',
    loading: 'Indlæser…',
    spotsLeft: 'ledige',
    of: 'af',
    noTrip: 'Ingen tur',
