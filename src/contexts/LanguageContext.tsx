...
const translations = {
  de: {
    ...
    descText: 'Das Boot startet direkt vor der Kajüte 1876. Vorher Flammkuchen, danach aufs Wasser — oder andersrum. Skipper Fynn kennt die Grachten, die Geschichten dahinter und das beste Licht auf dem Wasser.',
    // Kajüte section
  ...
  en: {
    ...
    descText: 'The boat departs right in front of Kajüte 1876. Tarte flambée first, then on the water — or the other way around. Skipper Fynn knows the canals, the stories behind them, and the best light on the water.',
