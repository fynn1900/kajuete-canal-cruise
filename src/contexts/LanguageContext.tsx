...
const translations = {
  de: {
    ...
    card3Exclusive: 'Exklusive Fahrt nur für euch zwei / eure Gruppe / Familie · +6 € pro Person',
  ...
  en: {
    ...
    card3Exclusive: 'Exclusive trip just for the two of you / your group / family · +€6 per person',
