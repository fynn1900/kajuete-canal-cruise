...
const translations = {
  de: {
    ...
    card2Sub: 'Mehr 1621-Bier & Drinks an Bord buchbar. Grachtenmusik und Geschichten über das Grachtenstädtchen vom Skipper persönlich — im Abendlicht auf dem Wasser.',
    card3Title: 'Preise',
    ...
    liabilityTitle: 'Einwilligungserklärung & Haftungsausschluss',
    ...
    liabilityCheck: 'Ich habe die Einwilligungserklärung gelesen und stimme den Bedingungen zu.',
    liabilityLink: 'Einwilligungserklärung & Haftungsausschluss',
    liabilityRequired: 'Bitte Haftungsbedingungen akzeptieren.',
    // Footer
  ...
  en: {
    ...
    card2Sub: 'More 1621-Beer & drinks available on board. Canal music and stories about the little Dutch town from the skipper himself — in the evening light on the water.',
    card3Title: 'Prices',
    ...
    liabilityTitle: 'Declaration of Consent & Disclaimer',
    ...
    liabilityCheck: 'I have read the declaration of consent and agree to the conditions.',
    liabilityLink: 'Declaration of Consent & Disclaimer',
    liabilityRequired: 'Please accept the liability conditions.',
    footerSlogan: 'Kajüte 1876 · Friedrichstadt',
